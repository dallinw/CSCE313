    set sopc "/usr/local/3rdparty/altera/quartus12/quartus//sopc_builder"
    set sopc_perl "/usr/local/3rdparty/altera/quartus12/quartus//linux/perl"
...
proc s_cycloneiv {} {
  if { [ expr ! [ string match "*ModelSim ALTERA*" [ vsim -version ] ] ] } {
    vlib work
    _init_setup
    set qsimlib /usr/local/3rdparty/altera/quartus12/quartus/eda/sim_lib
    set v_files [ list \
