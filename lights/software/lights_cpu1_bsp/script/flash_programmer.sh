...
#
/usr/local/3rdparty/altera/quartus12/nios2eds/bin/nios2-flash-programmer "../flash/myfile_cfi_flash_0.flash" --base=0x10800000 --sidp=0x112050C8 --id=0x0 --timestamp=1522333496 --device=1 --instance=0 '--cable=USB-Blaster on localhost [1-2]' --program --verbose 
